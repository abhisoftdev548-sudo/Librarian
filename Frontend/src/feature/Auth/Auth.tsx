  ...
  return (
    <div className='w-[90%] mx-auto py-5'>
      <nav className='flex justify-between items-center px-5'>
        ...
        <div className='flex w-full justify-end gap-8 font-medium text-[14px]'>
      ...
      <section className='flex justify-between mt-16'>
        ...
        <div>
          <span className='text-6xl font-black flex flex-col gap-2'><span>CREATE AND LEARN</span> <span>FROM YOUR OWN</span>   <span className='text-[#4F46E5]'>DIGITAL LIBRARY</span></span>
        </div>
        ...
        <div>
          ...
          <div className='absolute px-3 py-1 rounded-2xl border border-[#7e7ec8] text-[14px] font-bold bg-[#1b1b1e8b] text-white top-20 right-0'>No Distraction</div>
